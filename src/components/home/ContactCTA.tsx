    ...
    return (
        <Container className="mt-32 mb-20">
            <motion.div
                ...
                viewport={{ once: true }}
                className="relative overflow-hidden rounded-3xl bg-marine-card border border-white/10 p-8 text-center"
            >
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    <h2 className="text-2xl sm:text-3xl font-bold text-soft mb-6">
                        {lang === 'fr' ? "Prêt à démarrer un projet ?" : "Ready to start a project?"}
                    </h2>
                    <p className="text-soft-light text-lg mb-6 leading-relaxed">
                        {lang === 'fr'
                    ...
                    <Link
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-oranger text-white font-bold rounded-full hover:bg-orange-600 transition-all transform hover:scale-105 active:scale-95"
                    >
                        <Mail size={20} />
